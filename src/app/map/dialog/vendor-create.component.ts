...
export class VendorCreateComponent implements OnInit {
    ...
    ngOnInit() {        
        //插入初始資料
        this.VendorForm.controls['v3435'].setValue(this.data.v3435);
        this.VendorForm.controls['v3436'].setValue(this.data.v3436);
        this.VendorForm.controls['v3404'].setValue(this.data.v3404);
